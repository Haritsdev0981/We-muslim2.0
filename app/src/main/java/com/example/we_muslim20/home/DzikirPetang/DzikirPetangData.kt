...
object DzikirPetangData {
    ...
    val listDzikirPetang : ArrayList<DzikirPetangSetting>
    get() {
        var list = arrayListOf<DzikirPetangSetting>()
        for (position in descDzikirPetang.indices){
            val dzikirPetang = DzikirPetangSetting(
                descPtg = descDzikirPetang[position],
                lafazPtg = lafazDzikirPetang[position],
                terjemahanPtg = terjemahDzikirPetang[position]
            )
