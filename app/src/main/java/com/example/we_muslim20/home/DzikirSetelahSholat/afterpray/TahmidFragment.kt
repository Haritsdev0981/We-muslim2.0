...
class TahmidFragment : Fragment() {
    ...
    private var _binding : FragmentTahmidBinding? = null
    private val binding get() = _binding as FragmentTahmidBinding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTahmidBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
